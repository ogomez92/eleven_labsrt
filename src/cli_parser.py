...
def get_args():
    ...
    parser.add_argument('-p', '--prefer-speedup', help='Prefer speeding up audio to fit overlapping subtitles. If neither --prefer-speedup nor --prefer-queue is specified, queue is used.', action='store_true')
    parser.add_argument('-q', '--prefer-queue', help='Place overlapping subtitles sequentially. If this nor prefer speed up is specified, the app will ask.', action='store_true')
