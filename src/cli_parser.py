...
def create_arg_parser():
    ...
    parser.add_argument('-p', '--prefer-speedup', help='Prefer speeding up audio to fit overlapping subtitles. If neither speed up or sequential is specified, the program will ask.', action='store_true')
    parser.add_argument('-s', '--sequential', help='Place overlapping subtitles sequentially. If this nor prefer speed up is specified, the app will ask.', action='store_true')
